...
import OperationsPageDateBlock from './OperationPageDateBlock/OperationPageDateBlock';
...
export default class OperationsPage extends Component {
  ...
  render() {
    ...
    const popup = this.state.openPopup ? <EditOperationPage togglePopup={this.togglePopup} /> : null;
    ...
    return (
      <div className={cx('container', 'content')}>
        <div className={cx('popupWrapper')}>{popup}</div>
        ...
        <div className={cx('body')}>
          {groupsArray.map(({ date, items }, key) => (
            <OperationsPageDateBlock key={key} date={date} items={items} togglePopup={this.togglePopup} categories={categories} />
          ))}
        </div>
