...
export default class Test extends Component {
  ...
  filterCategory = (event) => {
    let results;
    if (!event.query) results = [...this.state.categories];
    else results = this.state.categories.filter((cat) => {
        ...
        <form className={cx('editOperationForm')}>
          <div className={cx('formBody')}>
            ...
            <div className={cx('btnWrapper')}>
              <Button label="Доход" className={cx('p-button-raised', 'p-button-secondary', 'editPageBtn')} onClick={(e) => e.preventDefault()} />
              <Button label="Расход" className={cx('p-button-raised', 'p-button-secondary', 'editPageBtn')} onClick={(e) => e.preventDefault()} />
            </div>
            <AutoComplete
            ...
            <div className={cx('checkboxWrapper')}>
              <Checkbox inputId="regularTrue" checked={this.state.checked} onChange={(e) => this.setState({ checked: e.checked })} />
            ...
            <InputTextarea className={cx('inputItem')} placeholder="Описание" autoResize />
          </div>
          <div className={cx('formFooter')}>
            <div className={cx('btnWrapper')}>
              ...
              />
              <Button label="ОК" className={cx('p-button-raised', 'p-button-primary', 'editPageBtn')} onClick={(e) => e.preventDefault()} />
            </div>
          </div>
        </form>
      </div>
