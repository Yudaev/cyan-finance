...
export class MainPage extends Component {
  ...
  drawPanels = (dataValue) => {
    ...
    if (dataValue.name === 'pageIncExp') return <PageIncExp />;
    if (dataValue.name === 'operationsPage') return <OperationsPage />;
    if (dataValue.name === 'editOperationPage') return <EditOperationPage />;
    if (dataValue.name === 'pageInputMail') return <PageInputMail />;
    if (dataValue.name === 'pageRecovery') return <PageRecovery />;
  };
